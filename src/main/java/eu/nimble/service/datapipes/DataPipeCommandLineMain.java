...
import eu.nimble.service.datapipes.runnables.ConsumerRunnable;
import eu.nimble.service.datapipes.runnables.ProducerRunnable;

import java.util.Set;
import java.util.UUID;

import static eu.nimble.service.datapipes.common.Configurations.MESSAGE_HUB_CREDENTIALS;

/**
 * Created by evgeniyh on 3/29/18.
 */

public class DataPipeCommandLineMain {
    private static final Logger logger = Logger.getLogger(DataPipeCommandLineMain.class);
