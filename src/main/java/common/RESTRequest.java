...
public class RESTRequest {
     ...
     *
     * @param target       {String} The REST API target to run against (for example,
     *                     '/admin/topics')
     * @param acceptHeader {Boolean} A flag to notify the caller whether or not to
     ...
     * @param target            {String} The REST API target to run against (for example,
     *                          '/admin/topics')
     * @param body              {String} The data to be provided in the body section of the
     *                          POST request.
     * @param ignoredErrorCodes {int[]} An list of error codes which will be ignored as a
